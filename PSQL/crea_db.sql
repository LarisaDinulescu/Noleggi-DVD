...
/*6) creazione delle tabelle:*/
	...
	CREATE TABLE noleggio(
		...
		data_fine date, 
		consegna_fuori_tempo BOOLEAN DEFAULT FALSE, /*attributo aggiunto per garantire il seguente vincolo di integrità: la durata del noleggio deve essere compresa tra 2 e 7 gg, vedi trigger 2*/
		/*vincoli di tabella*/
...
/*7) Creo i trigger*/
/*1) Trigger per l'incremento del numero dei noleggi del dvd una volta preso in prestito*/
...
/*2) Trigger per soddisfare il vincolo di integrità n°2
Nel momento della restituzione del noleggio controlla se la durata dello stesso è compresa tra 2 e 7 gg, se non lo è imposta a true l'attributo consegna_fuori_tempo*/
